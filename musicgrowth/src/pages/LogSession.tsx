    ...
    <div className="animate-fade-up max-w-xl mx-auto">
      <div className="mb-6">
        <h1 className="font-display text-3xl sm:text-4xl text-forest-800 mb-1">
          Log session<span className="text-gold-400">.</span>
        </h1>
      ...
      <div className="flex gap-3 mb-5">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium transition-all ${
            type === 'voice'
              ? 'bg-blush-100 text-blush-300 border border-blush-200'
              : 'bg-white border border-cream-200 text-forest-400'
          }`}
        >
          <Mic2 size={16} /> Voice
        </button>
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium transition-all ${
            type === 'ear_training'
              ? 'bg-forest-800 text-gold-300 border border-forest-700'
              : 'bg-white border border-cream-200 text-forest-400'
          }`}
        >
        ...
        {type === 'voice' && (
          <div>
            ...
            <input
              ...
              placeholder="e.g. Rise Up, Halo (comma separated)"
              className="input"
            />
          </div>
        )}
